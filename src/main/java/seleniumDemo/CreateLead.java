...
driver.get("http://leaftaps.com/opentaps/control/login");
	...
	// Verify title of the page(for verifying first name, we use getText() and stored
	// the value in firstName and print)

	//String changeName = driver.findElementById("viewLead_firstName_sp").getText();
	String title = driver.getTitle();
	System.out.println(title);

	//System.out.println("Element not found");

	//if (changeName.equals("Hema")) {
